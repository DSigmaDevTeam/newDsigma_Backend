                                                                                                    ...
                                                                                                    <td
                                                                                                        ...
                                                                                                        <div style="font-family:inherit;text-align:center">
                                                                                                            <p style="color:#000000;letter-spacing:4px;margin-bottom:30px; font-weight: 600;font-size: 24px">
                                                                                                                <span style="background-color: #fff; padding: 10px 7px;margin: 3px;">${pin.substring(0,1)}</span>
                                                                                                                <span style="background-color: #fff; padding: 10px 7px;margin: 3px">${pin.substring(1,2)}</span>
                                                                                                                <span style="background-color: #fff; padding: 10px 7px;margin: 3px">${pin.substring(2,3)}</span>
                                                                                                                <span style="background-color: #fff; padding: 10px 7px;margin: 3px">${pin.substring(3,4)}</span>
                                                                                                                <span style="background-color: #fff; padding: 10px 7px;margin: 3px">${pin.substring(4,5)}</span>
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
